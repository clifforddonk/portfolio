      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-6 items-center">
          {["Home", "About", "Skills", "Projects", "Contact", "Blog"].map(
            (item, index) => {
              const href =
                item === "Blog" ? "/blog" : `/homepage#${item.toLowerCase()}`;
              return (
                <motion.a
                  key={item}
                  href={href}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="ml-2 p-2 rounded-full bg-gray-800 text-gray-200 hover:bg-gray-700 transition-colors"
        ...
        <div className="flex items-center md:hidden space-x-3">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="z-50 p-2 rounded-full bg-gray-800 hover:bg-gray-700 transition-colors"
        ...
        >
          ...
          <motion.button
            onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
            className="mt-12 px-6 py-3 rounded-full font-medium text-sm flex items-center space-x-2 bg-gray-800 text-gray-200 hover:bg-gray-700 transition-colors"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
